...
/******************************************************************************
                            1:修改产品信息                
******************************************************************************/
#define PRODUCT_KEY "hwumoz2vfhi7arvh"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//清扫模式(可下发可上报)
//备注:【必选】枚举值按需选择，不需要的可删除
//smart：自动清扫， wall_follow：沿边清扫 ， spiral:定点清扫, chargego:回充模式
...
//工作状态(只上报)
//备注:休眠、待机、工作中、回充中、充电完成、座充中、直充中、故障、其他故障
...
//清扫记录(只上报)
//备注:可选择将地图ID号同时上报/
//清扫日期+ YYYYMMDDTTRR 清扫时长 + XXX 清扫面积 xxx 如： "20180411051102008000020" 代表2018年4月11日05点11分，清扫了20分钟，80平方米 ，id号为20（假如MCU没有RTC，时间可不上报。记录则默认显示为数据上报时间）
...
//共3个字节,第一个字节为原点（0,0）位置，二三字节为地图最大的长宽
//0x00 左上角
//0x01 左下角 
