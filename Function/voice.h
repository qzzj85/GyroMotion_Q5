...
#define		VOICE_ERROR_LIFT			BASE_NUM+24			//为了适配新旧语音芯片，修改
#define		VOICE_ERROR_L_LIFT			BASE_NUM+24			//为了适配新旧语音芯片，修改
#define		VOICE_ERROR_R_LIFT			BASE_NUM+24			//为了适配新旧语音芯片，修改
#define		VOICE_LONG_PRESS			BASE_NUM+25			//重置WIFI 3秒时间到
...
#define		VOICE_ERROR_L_RING			BASE_NUM+52			//为了适配新旧语音芯片，修改
#define		VOICE_ERROR_R_RING			BASE_NUM+52			//为了适配新旧语音芯片，修改轮子
...
#define		VOICE_ERROR_L_SB			BASE_NUM+58			//为了适配新旧语音芯片，修改
#define		VOICE_ERROR_R_SB			BASE_NUM+58			//为了适配新旧语音芯片，修改边扫
#define		VOICE_ERROR_DC_EXIST		BASE_NUM+59			//拔掉充电线
#endif
...
#define		VOICE_WIFI_RST				BASE_NUM+22			//重置WIFI 3秒时间到
...
#define		VOICE_ERROR_DC_EXIST		BASE_NUM+30			//拔掉充电线
#define		VOICE_STOP_CHARGE			BASE_NUM+31			//停止充电
